...
### 💡 C# • .NET • SQL • AWS • Perícia Documental • Análise Forense Digital
...
Integro técnicas grafotécnicas tradicionais com **análise de metadados, padrões eletrônicos e ferramentas de TI**, unindo perícia documental e tecnologia.
...
⭐ **24% de redução nos incidentes**  
⭐ Automação de relatórios (AWS Lambda)  
⭐ Participação direta em **8 deploys e 6 funcionalidades**  
⭐ Revisão de código, testes e melhorias estruturais  
